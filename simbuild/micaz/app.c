...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7c10458, const void *arg_0xb7c105f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7bc18c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a6b840), 
int (*key_eq_fn)(void *arg_0xb7a6bc88, void *arg_0xb7a6be00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb793a9b8, int arg_0xb793ab10);
static double RandomUniform(void );
...
typedef uint16_t sendAckC$DataRead$val_t;
typedef TMilli sendAckC$Timer1$precision_tag;
...
static void sendAckC$DataRead$readDone(error_t result, sendAckC$DataRead$val_t val);
...
static void sendAckC$Timer1$fired(void );
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static error_t sendAckC$DataRead$read(void );
...
uint8_t len);
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void sendAckC$Timer1$startPeriodic(uint32_t dt);
#line 78
static void sendAckC$Timer1$stop(void );
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
...
static inline void sendAckC$Timer1$fired(void );
#line 141
...
#line 206
static inline void sendAckC$DataRead$readDone(error_t result, uint16_t data);
# 53 "/opt/tinyos-main-2.1.2/tos/chips/atm128/timer/HplAtm128TimerCtrl8.nc"
...
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
inline static error_t sendAckC$DataRead$read(void ){
#line 55
...
#line 195
      if (__nesc_ntoh_uint8(msg->type.nxdata) == 1) {
          sendAckC$counter[sim_node()] = __nesc_ntoh_uint8(msg->counter.nxdata);
          sim_log_debug(162U, "radio_pack", "Mote 2: received a REQuest packet, it was number=%d, sorry I didn't hear the previous %d :(\n", sendAckC$counter[sim_node()], sendAckC$counter[sim_node()] - 1);
          sendAckC$sendResp();
        }
      return buf;
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76deac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76deac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76deac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb76db178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb76db178, msg, payload, len);
#line 78
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void sendAckC$Timer1$startPeriodic(uint32_t dt){
#line 64
...
#line 103
{
  if (err == SUCCESS) {
      switch (TOS_NODE_ID) {
          case 1: 
            sim_log_debug(152U, "radio_on", "RADIO 1 ACCESA CORRETTAMENTE, TOS_NODE_ID=%d\n", TOS_NODE_ID);
          sendAckC$Timer1$startPeriodic(1000);
          break;
          case 2: 
            sim_log_debug(153U, "radio_on", "RADIO 2 ACCESA CORRETTAMENTE, TOS_NODE_ID=%d\n", TOS_NODE_ID);
          break;
        }
    }
  else 
#line 114
    {
      sim_log_error(154U, "radio_error", "RADIO ERROR, RESTART RADIO\n");
...
#line 121
{
  ...
  sim_log_debug(155U, "radio_rec", "RADIO SWITCHED OFF TO PREVENT IDLE LISTENING POWER CONSUMPTION.\n");
}
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76de108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76de108, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb73e5ca8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb73e5ca8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb73e5ca8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb7896650){
#line 75
  switch (arg_0xb7896650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb7896650);
#line 75
      break;
#line 75
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void sendAckC$Timer1$stop(void ){
#line 78
...
#line 67
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb73e2730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb73e2730, addr, msg, len);
#line 80
...
#line 56
  ...
  __nesc_hton_uint8(msg->counter.nxdata, sendAckC$counter[sim_node()]);
  __nesc_hton_uint8(msg->type.nxdata, 1);
  __nesc_hton_uint8(msg->data.nxdata, 0);




  if (sendAckC$PacketAcknowledgements$requestAck(&sendAckC$packet[sim_node()]) == SUCCESS) {
      sim_log_debug(148U, "radio_ack", "Mote 1:requested ACK. \n");
    }
  else {
      sim_log_error(149U, "error_ack", "Mote 1:Error ACK\n");
    }


  if (sendAckC$AMSend$send(2, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      sim_log_debug(150U, "radio_send", "Mote 1: packet sent.\n");
    }
}
...
#line 127
{
  ...
  sim_log_debug(156U, "radio_on", "Counter Request value=%d\n", sendAckC$counter[sim_node()]);
  sendAckC$sendReq();
}
...
#line 216
  if (sendAckC$data_lock[sim_node()] == TRUE) {
      sendAckC$temp[sim_node()] = (double )data / 65535 * 100;
      sendAckC$data_lock[sim_node()] = FALSE;
    }

  sim_log_debug(163U, "fake_sensor_value", "The value of the sensor is: %f\n", sendAckC$temp[sim_node()]);
  ...
  __nesc_hton_uint8(msg->data.nxdata, sendAckC$temp[sim_node()]);



  if (sendAckC$PacketAcknowledgements$requestAck(&sendAckC$packet[sim_node()]) == SUCCESS) {
      sim_log_debug(164U, "radio_ack", "Mote 2: requested ACK for response.\n");
    }


  if (sendAckC$AMSend$send(1, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      sim_log_debug(165U, "radio_send", "Mote 2: packet response sent correctly, waiting for ACK.\n");
    }
}
...
#line 63
  sendAckC$DataRead$readDone(result, val);
#line 63
}
#line 63
# 24 "FakeSensorP.nc"
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb745a3a8){
#line 83
  switch (arg_0xb745a3a8) {
#line 83
    case 0U:
#line 83
      sendAckC$Timer1$fired();
#line 83
      break;
#line 83
    case 1U:
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb745a3a8);
#line 83
      break;
#line 83
    }
...
#line 97
{
  sim_log_debug(151U, "boot", "APPLICATION BOOTED.\n");
  sendAckC$SplitControl$start();
}
...
#line 141
{
  ...
  if (&sendAckC$packet[sim_node()] == buf && err == SUCCESS) {
      sim_log_debug(157U, "radio_send", "Message sent correctly. :)\n");
    }
  else 
#line 153
    {
      sim_log_debug(158U, "radio_send", "Sending error\n");
    }
  ...
  switch (TOS_NODE_ID) {
      case 1: 
        if (sendAckC$PacketAcknowledgements$wasAcked(buf)) {
            sendAckC$Timer1$stop();
            sim_log_debug(159U, "radio_rec", "Mote 1:ACK received so stop timer 1,bye. \n");
          }
      break;
      case 2: 
        if (sendAckC$PacketAcknowledgements$wasAcked(buf)) {
            sim_log_debug(160U, "radio_rec", "Mote 2:ACK received stop radio 2,bye. \n");
            sendAckC$data_lock[sim_node()] = TRUE;
            sendAckC$SplitControl$stop();
          }
        else {
            sim_log_debug(161U, "radio_rec", "Mote 2:ACK not received :(, sending again the response.\n");
            sendAckC$sendResp();
          }
      break;
    }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "sendAckC$data_lock"))
  {
    *addr = (uintptr_t)&sendAckC$data_lock[__nesc_mote];
    *size = sizeof(sendAckC$data_lock[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "sendAckC$temp"))
  {
    *addr = (uintptr_t)&sendAckC$temp[__nesc_mote];
    *size = sizeof(sendAckC$temp[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  sendAckC$data_lock[__nesc_mote] = TRUE;
  memset((void *)&sendAckC$temp[__nesc_mote], 0, sizeof sendAckC$temp[__nesc_mote]);
